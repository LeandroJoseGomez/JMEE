...
class TokenizerTest extends ExpressionHandler {
    ...
    @Test
    void tokenize() {
        List<String> tokens = new Tokenizer().tokenize("3+2 * 5^2");
    ...
    @Test
    void tokenize_2() {
        List<String> tokens = new Tokenizer().tokenize("Sin(X)-cOs(y)");
    ...
    void tokenize_3() {
        ...
        List<String> tokens = new Tokenizer().tokenize("-7/-(-3+-3.33*4- -20/10)^2");
    ...
    @Test
    void tokenize_4() {
        List<String> tokens = new Tokenizer().tokenize("sin(pi / 2)");
    ...
    @Test
    void tokenize_5() {
        List<String> tokens = new Tokenizer().tokenize("4 * -abs(-5)");
